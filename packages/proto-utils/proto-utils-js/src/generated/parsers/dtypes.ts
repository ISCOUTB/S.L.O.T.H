...
export namespace dtypes {
    ...
    export class AST extends pb_1.Message {
        #one_of_decls: number[][] = [[10, 11, 12], [2], [3], [4], [6], [7], [8], [9], [13]];
        constructor(data?: any[] | ({
            ...
            if (!Array.isArray(data) && typeof data == "object") {
                ...
                if ("sheet_name" in data && data.sheet_name != undefined) {
        ...
        static fromObject(data: {
            ...
            if (data.sheet_name != null) {
                message.sheet_name = data.sheet_name;
            }
            return message;
        }
        toObject() {
            ...
            if (this.sheet_name != null) {
                data.sheet_name = this.sheet_name;
            }
            return data;
        }
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.has_sheet_name)
                writer.writeString(13, this.sheet_name);
            if (!w)
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    ...
                    case 12:
                        ...
                        break;
                    case 13:
                        message.sheet_name = reader.readString();
                        break;
